this.tutorial_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function create()
	{
		...
		this.m.Name = "Odbudowa Kompanii (Tutorial)";
		this.m.Description = "[p=c][img]gfx/ui/events/event_21.png[/img][/p][p]Jesteś zastępcą kapitana w kompanii najemników, która już od jakiegoś czasu tropi bandytę o imieniu Hoggart. Niespodziewany zwrot wydarzeń sprawił, że kompania leży w rozsypce, a ty jako nowy dowódca musisz odbudować ją do dawnej chwały. \n\n[color=#bcad8c]Zalecany scenariusz dla nowych graczy, gdyż zawiera nieco wskazówek na początek rozgrywki.[/color][/p]";
		this.m.Difficulty = 1;
		this.m.Order = 0;
	}
	...
	function onSpawnAssets()
	{
		...
		for( local i = 0; i < 3; i = i )
		{
			...
			bro.worsenMood(0.5, "Utracił większość kompanów");
