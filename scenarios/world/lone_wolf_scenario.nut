this.lone_wolf_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function create()
	{
		...
		this.m.Name = "Samotny Wilk";
		this.m.Description = "[p=c][img]gfx/ui/events/event_35.png[/img][/p][p]Podróżujesz samotnie już od dłuższego czasu, biorąc udział w turniejach i sparingach z młodymi szlachcicami. Jako błędny rycerz, rosły niczym dąb, nigdy nikogo nie potrzebowałeś. Czy to nadal prawda?\n\n[color=#bcad8c]Samotny Wilk:[/color] Rozpoczynasz grę z jednym doświadczonym błędnym rycerzem i świetnym ekwipunkiem, lecz z niewielkimi funduszami.\n[color=#bcad8c]Wąska Elita:[/color] Nie możesz mieć więcej niż 12 ludzi.\n[color=#bcad8c]Awatar:[/color] Gdy twój błędny rycerz zginie, kampania zostaje zakończona.[/p]";
		this.m.Difficulty = 3;
		this.m.Order = 110;
	...
	function onSpawnAssets()
	{
		...
		bro.getBackground().m.RawDescription = "Jesteś wędrującym błędnym rycerzem, weteranem turniejów i pojedynków na kopie. Byłeś też weteranem zwycięstwa. To dość niepokojąca myśl, ale jeżeli cokolwiek sprawiło, że zainteresowałeś się pracą najemnika, to była to nuda. Wmawiasz sobie, że chodzi tylko o pieniądze, jednak jakaś część ciebie wie, że robisz to także dla towarzystwa.";
