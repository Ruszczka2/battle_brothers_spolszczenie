this.bounty_hunter_follower <- this.inherit("scripts/retinue/follower", {
	...
	function create()
	{
		...
		this.m.Name = "Łowca Nagród";
		this.m.Description = "Ten barwny Łowca Nagród ma kieszenie wypchane kontraktami na najbardziej niebezpiecznych osobników. Wie jak wywabić ich z ukrycia i szczodrze zapłaci za każde wypełnione zadanie.";
		this.m.Image = "ui/campfire/bounty_hunter_01";
		this.m.Cost = 4000;
		this.m.Effects = [
			"Znacznie wyższa szansa na spotkanie czempionów",
			"Płaci od 300 do 750 koron za każdego zabitego czempiona"
		];
		this.m.Requirements = [
			{
				IsSatisfied = false,
	...
	function onEvaluate()
	{
		...
		this.m.Requirements[0].Text = "Miej w posiadaniu " + this.Math.min(3, namedItems) + "/3 nazwane lub legendarne przedmioty";
