this.medium_mining_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Rozciągnięta osada, przytulona do zboczy otaczających ją gór";
		this.m.Description = "Rozciągnięta osada, przytulona do zboczy otaczających ją gór. Odgłosy kilofów uderzających w skały słychać z daleka.";
