this.large_steppe_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Duże miasto kwitnące dzięki handlowi i sztukom pięknym";
		this.m.Description = "Duże miasto kwitnące na południowym stepie dzięki handlowi, produkcji wartościowych dóbr oraz sztukom pięknym.";
