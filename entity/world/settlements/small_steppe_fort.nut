this.small_steppe_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Mała drewniana warownia na suchym stepie";
		this.m.Description = "Ta mała drewniana warownia pilnuje szerokiego, suchego stepu i oferuje schronienie dla znużonych żołnierzy.";
