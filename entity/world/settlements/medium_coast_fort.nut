this.medium_coast_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Kamienna twierdza, która kontroluje ważny strategicznie port i chroni pobliskie szlaki handlowe";
		this.m.Description = "Kamienna twierdza, która kontroluje ważny strategicznie dostęp do morza i chroni pobliskie szlaki handlowe.";
