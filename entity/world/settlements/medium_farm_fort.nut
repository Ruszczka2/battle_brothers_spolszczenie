this.medium_farm_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Kamienna warownia otoczona przez żyzne ziemie";
		this.m.Description = "Kamienna warownia otoczona przez żyzne ziemie i służą jako baza wojskowa w regionie.";
