this.small_farming_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Mała wioska rolnicza żyjąca głównie z otaczających ją żyznych ziem";
		this.m.Description = "Mała wioska rolnicza żyjąca głównie z otaczających ją żyznych ziem.";
