this.large_snow_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Ta wielka cytadela dostojnie góruje nad bezkresnym śniegiem";
		this.m.Description = "Ta wielka cytadela dostojnie góruje nad bezkresnym śniegiem i jest twierdzą chroniącą przed wszystkim, co może nadejść z dalekiej północy. Jako że ludzie przez lata ściągali tutaj w poszukiwaniu bezpieczeństwa, w okolicy powstały liczne domy i warsztaty, dzięki czemu osada pełni teraz rolę nie tylko schronienia, ale też i punktu zaopatrzeniowego dla wędrowców, najemników i poszukiwaczy przygód.";
