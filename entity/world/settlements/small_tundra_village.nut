this.small_tundra_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Skromna wioska, która jakoś zdołała przetrwać w skąpej tundrze";
		this.m.Description = "Skromna wioska, która jakoś zdołała przetrwać w skąpej tundrze.";
