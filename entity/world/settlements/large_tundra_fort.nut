this.large_tundra_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Wielka cytadela, górująca nad otaczającą ją tundrą";
		this.m.Description = "Wielka cytadela, górująca nad otaczającą ją tundrą i zabezpieczając pokaźny i otwarty region. Wielu przybywa tu by zakupić zapasy, dokonać napraw sprzętu i odpocząć przed dalszą podróżą.";
