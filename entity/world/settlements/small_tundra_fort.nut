this.small_tundra_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Drewniany gródek wznoszący się nad tundrą";
		this.m.Description = "Na płaskich ziemiach tundry, ta niewielka fortyfikacja widoczna jest z dość daleka.";
