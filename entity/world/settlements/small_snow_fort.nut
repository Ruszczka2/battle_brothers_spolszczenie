this.small_snow_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Ten niewielki gródek wznoszący się nad bezkresnym śniegiem";
		this.m.Description = "Ten mały gródek wznosi się nad bezkresnym śniegiem i oferuje schronienie przed chłodem oraz ciepły posiłek dla stacjonującego tu garnizonu.";
