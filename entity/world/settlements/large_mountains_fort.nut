this.large_mountains_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Masywna cytadela wbudowana bezpośrednio w strome zbocza góry";
		this.m.Description = "Ta masywna cytadela została wbudowana w strome zbocza góry. Stacjonuje tu wielu ludzi, aby pewnie pełnić pieczę nad okolicą.";
