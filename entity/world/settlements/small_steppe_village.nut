this.small_steppe_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Mała wioska na stepie, żyjąca głównie ze skromnego handlu";
		this.m.Description = "Mała wioska na stepie, żyjąca głównie ze skromnego handlu.";
