this.small_snow_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Kilka chat stłoczonych razem";
		this.m.Description = "Mała grupka chatek stłoczonych razem, opierających się srogim, śnieżnym wiatrom północy.";
