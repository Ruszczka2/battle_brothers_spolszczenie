this.large_snow_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Duże miasto, oferujące schronienie dla podróżnych i kupców przed śniegiem i chłodem";
		this.m.Description = "Duże miasto na dalekie północy. Kupcy, podróżnicy, i poszukiwacze przygód ściągają tu, by schronić się przed lodowatym chłodem i burzami śnieżnymi.";
