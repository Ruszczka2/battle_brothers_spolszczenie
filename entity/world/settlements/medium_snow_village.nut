this.medium_snow_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Średniego rozmiaru wioska pokryta śniegiem przez większość roku";
		this.m.Description = "Średniego rozmiaru wioska pokryta śniegiem przez większość roku.";
