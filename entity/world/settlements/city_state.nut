this.city_state <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Wielkie i bogate państwo-miasto, które prosperuje dzięki handlowi na obrzeżach pustyni";
		this.m.Description = "Wielkie i bogate państwo-miasto, które prosperuje dzięki handlowi na obrzeżach pustyni.";
