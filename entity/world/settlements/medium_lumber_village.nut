this.medium_lumber_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Rozwinięta wioska prosperująca na drewnie i zwierzynie łownej";
		this.m.Description = "Wioska założona w pobliżu lasu, żyjąca głównie z pozyskiwania drewna i zwierzyny łownej.";
