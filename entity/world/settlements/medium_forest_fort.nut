this.medium_forest_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Potężna kamienna twierdza otoczona przez lasy.";
		this.m.Description = "Ta potężna kamienna twierdza otoczona przez lasy służy jako okoliczna baza wypadowa dla wojska.";
