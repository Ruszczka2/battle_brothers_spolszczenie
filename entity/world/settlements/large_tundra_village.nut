this.large_tundra_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Duże miasto i ośrodek handlowy otoczony przez jałową tundrę";
		this.m.Description = "Otoczone przez jałową tundrę, to wielkie miasto przetrwało jako ważny ośrodek handlowy oraz dom dla myślicieli i sztuk pięknych.";
