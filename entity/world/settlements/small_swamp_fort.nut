this.small_swamp_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Gródek wybudowany na skrawku suchej ziemi";
		this.m.Description = "Umiejscowiony na małym skrawku twardej gleby, ten gródek kontroluje okoliczne ziemie.";
