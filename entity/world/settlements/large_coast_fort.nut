this.large_coast_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Ta masywna cytadela strzeże wojskowego portu i okolicznych szlaków handlowych";
		this.m.Description = "Ta masywna cytadela strzeże wojskowego portu i okolicznych szlaków handlowych. Jest siedzibą władzy dla szlachty i mieści w sobie pokaźny garnizon.";
