this.large_lumber_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Prosperujące miasto, którego głównymi produkowanymi towarami są drewno i dziczyzna";
		this.m.Description = "Prosperujące miasto ulokowane w pobliżu lasu, produkujące głównie towary takie jak drewno i dziczyzna.";
