this.large_farming_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Wielkie miasto kwitnące dzięki handlowi i rolnictwu";
		this.m.Description = "Wielkie miasto otoczone przez bujne zielone pastwiska, sady i pola uprawne. Spichlerze są tutaj zazwyczaj wypełnione po brzegi.";
