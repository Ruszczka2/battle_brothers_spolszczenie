this.medium_farming_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Prosperująca wioska otoczona przez żyzne ziemie";
		this.m.Description = "Prosperująca wioska otoczona przez żyzne ziemie. Targ zazwyczaj przepełniony jest różnego rodzaju świeżą żywnością.";
