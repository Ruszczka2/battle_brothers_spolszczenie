this.medium_snow_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Ta kamienna warownia chroni garnizon przed śniegiem";
		this.m.Description = "Ta zbudowana z kamienia warownia oferuje schronienie zarówno przed chłodem, jak i wszelkimi najeźdźcami.";
