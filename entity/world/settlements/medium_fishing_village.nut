this.medium_fishing_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Większa, rozproszona wioska, polegająca głównie na rybołówstwie i odrobinie handlu";
		this.m.Description = "Większa, rozproszona wioska, polegająca głównie na rybołówstwie i odrobinie handlu.";
