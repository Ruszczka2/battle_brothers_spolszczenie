this.large_steppe_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Potężna cytadela górująca nad otaczającym ją stepem";
		this.m.Description = "Potężna cytadela górująca wyraźnie nad otaczającym ją stepem, będąca siedzibą władzy w regionie. Mieści w sobie wielki garnizon i oferuje wszelkie usługi istotne dla podróżnych i najemników.";
