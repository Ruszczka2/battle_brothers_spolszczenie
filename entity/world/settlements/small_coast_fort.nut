this.small_coast_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Drewniany gródek górujący wyraźnie nad pobliskim wybrzeżem";
		this.m.Description = "Drewniany gródek górujący wyraźnie nad pobliskim wybrzeżem.";
