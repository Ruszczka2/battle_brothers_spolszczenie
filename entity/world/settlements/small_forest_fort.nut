this.small_forest_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Wojskowa fortyfikacja otoczona przez lasy";
		this.m.Description = "Otoczona przez lasy, ta mała drewniana warownia kontroluje otaczające ją tereny leśne.";
