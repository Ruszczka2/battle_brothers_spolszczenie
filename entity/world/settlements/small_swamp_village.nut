this.small_swamp_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Mała i prymitywna osada w bagiennym regionie";
		this.m.Description = "Mała osada w bagiennym regionie. Żyjący tu ludzie zapewne doskonale wiedzą co to niedola.";
