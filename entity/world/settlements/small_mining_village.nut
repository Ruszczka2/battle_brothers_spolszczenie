this.small_mining_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Kilka chat i małych budynków dających dom pracownikom pobliskich kopalń";
		this.m.Description = "Kilka chat i małych budynków dających dom pracownikom pobliskich kopalń.";
