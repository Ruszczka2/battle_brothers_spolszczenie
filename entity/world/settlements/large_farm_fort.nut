this.large_farm_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Masywna cytadela górująca nad otwartymi równinami";
		this.m.Description = "Masywna cytadela górująca nad otaczającymi ją otwartymi równinami. Siedziba władzy dla szlachty, mieszcząca liczne uzbrojone siły, aby pewnie pełnić pieczę nad okolicą.";
