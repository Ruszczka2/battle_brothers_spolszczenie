this.large_swamp_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Skromne miasto, rozsiane po suchych partiach bagiennego terenu";
		this.m.Description = "Zbiór wielu mniejszych osad, rozsianych po suchych partiach bagiennego terenu, tworzących wspólnie skromne miasto.";
