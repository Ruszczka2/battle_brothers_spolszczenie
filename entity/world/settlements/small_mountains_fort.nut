this.small_mountains_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Mała fortyfikacja wbudowana w zbocza góry";
		this.m.Description = "Mała fortyfikacja została wybudowana w tych górach, aby kontrolować otaczające ją ziemie i służyć jako baza wypadowa.";
