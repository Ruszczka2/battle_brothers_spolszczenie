this.medium_steppe_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Kamienna warownia chroniąca władzę nad płaskim stepem";
		this.m.Description = "Ta kamienna warownia jest silnym punktem w okolicy, z dobrym widokiem na otaczające ją płaskie i suche ziemie.";
