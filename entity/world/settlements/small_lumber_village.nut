this.small_lumber_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Wioska żyjąca z pozyskiwania drewna i wszystkiego tego, co oferuje las";
		this.m.Description = "Wioska żyjąca z pozyskiwania drewna i wszystkiego tego, co oferuje las.";
