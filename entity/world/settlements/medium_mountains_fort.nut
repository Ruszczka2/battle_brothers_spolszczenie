this.medium_mountains_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Kamienna twierdza, która wyraźnie góruje na okolicznymi górami";
		this.m.Description = "Kamienna twierdza, która wyraźnie góruje na okolicznymi górami. Wartownicy na wieżach z wielu mil mogą dostrzec nadchodzące zagrożenie.";
