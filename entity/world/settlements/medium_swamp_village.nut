this.medium_swamp_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Duża osada otoczona przez cuchnące bagna";
		this.m.Description = "Dość duża osada, rozsiana po różnych suchych i pewnych miejscach bagien.";
