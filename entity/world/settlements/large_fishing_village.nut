this.large_fishing_village <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Wielkie nabrzeżne miasto i ośrodek handlowy";
		this.m.Description = "Duże portowe miasto, polegające głównie na handlu i rybołówstwie, będące ważnym ośrodkiem handlowym dla podróżnych przybywających lub odpływających na okrętach.";
