this.medium_tundra_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Kamienna warownia ochraniająca okoliczną tundrę";
		this.m.Description = "Kamienna warownia, która jest siedzibą władzy na okolicznej tundrze. Pełni rolę bazy wojskowej dla pokaźnego garnizonu.";
