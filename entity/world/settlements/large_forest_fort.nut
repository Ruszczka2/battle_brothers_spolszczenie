this.large_forest_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Cytadela górująca wyraźnie nad otaczającymi ją lasami";
		this.m.Description = "Ta cytadela góruje wyraźnie nad otaczającymi ją lasami i dominuje nad regionem.";
