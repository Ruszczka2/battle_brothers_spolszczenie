this.medium_swamp_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function create()
	{
		...
		this.m.UIDescription = "Kamienna twierdza kontrolująca szlaki biegnące przez bagna";
		this.m.Description = "Kamienna twierdza kontrolująca biegnące tu szlaki oraz dostęp do bagien i mokradeł.";
