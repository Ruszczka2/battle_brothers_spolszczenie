this.orc_fortress_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Potężna forteca wykonana z masywnych beli żelaza, pokryta plemiennymi malowidłami wojennymi. Krwiożercze wrzaski orków rozbrzmiewające za murami można dosłyszeć z daleka.";
	}
	...
	function onSpawned()
	{
		this.m.Name = "Forteca Wodza Wojennego";
