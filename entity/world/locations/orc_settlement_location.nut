this.orc_settlement_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Duże i cuchnące morze namiotów, z namiotem wodza i wielką salą tronową pośrodku. Jest to dom dla całego plemienia, aż ostatecznie przemieści się ono w inne miejsce, by tam napadać i plądrować.";
	}
