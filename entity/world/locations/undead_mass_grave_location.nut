this.undead_mass_grave_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Smutne pozostałości po bezlitosnej bitwie, epidemii lub innej katastrofie. Ocalali wykopali wielki dół i złożyli w nim zwłoki, aby szybko się ich pozbyć.";
	}
