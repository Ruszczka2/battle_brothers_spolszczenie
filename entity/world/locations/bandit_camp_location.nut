this.bandit_camp_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Ufortyfikowane palisadami obozowisko, używane przez banitów do składowania swych łupów, odpoczynku pomiędzy najazdami i urządzania pijackich zabaw.";
	}
