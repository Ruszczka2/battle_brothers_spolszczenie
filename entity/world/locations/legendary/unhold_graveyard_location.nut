this.unhold_graveyard_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Szeroki połać ziemi zaśmiecony olbrzymimi kośćmi i czaszkami. Niektóre wyblakły już i pobielały, niektóre zaś są świeże i nadal mają przyczepione kawałki mięsa.";
	}
	...
	function onSpawned()
	{
		this.m.Name = "Cmentarzysko Unholdów";
