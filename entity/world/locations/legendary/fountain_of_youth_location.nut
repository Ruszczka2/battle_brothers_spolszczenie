this.fountain_of_youth_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Mała polana w lesie skupiona wokół ciekawego, smukłego drzewa. Coś wydaje się dziwnego w tym drzewie, choć z odległości ciężko ocenić co.";
	}
