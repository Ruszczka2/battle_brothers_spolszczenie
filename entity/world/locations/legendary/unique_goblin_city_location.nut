this.unique_goblin_city_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Wielkie goblińskie miasto, zagnieżdżone w pozostałościach po starożytnej fortecy. Chronione przez ciemne i wyniosłe mury, jest domem dla całej armii zaciekłych zielonoskórych.";
	}
