this.black_monolith_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Smoliście czarny monolit wznosi się nad okolicznymi ziemiami, emitując złowrogą aurę. Żadne żywe stworzenie nie ośmiela się do niego zbliżyć.";
	}
