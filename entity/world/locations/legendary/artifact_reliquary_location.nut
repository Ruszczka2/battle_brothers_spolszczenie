this.artifact_reliquary_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Zawalona ruina z zamierzchłych czasów. Okazjonalne migotanie pochodni, podobnie jak dziwne dźwięki wydobywające się z głębin, zdradzają obecność żywych mieszkańców.";
	}
	...
	function onSpawned()
	{
		this.m.Name = "Relikwiarz Artefaktów";
