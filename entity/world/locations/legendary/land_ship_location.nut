this.land_ship_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Na koronach drzew znajduje się duża drewniana konstrukcja. Mimo iż wydaje się to dziwne, bardzo przypomina ona okręt.";
	}
	...
	function onSpawned()
	{
		this.m.Name = "Osobliwy Wrak Okrętu";
