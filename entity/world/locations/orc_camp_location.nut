this.orc_camp_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Mały obóz założony przez Orków, będących albo częścią większej hordy w pobliżu, albo małymi plemionami działającymi na własną rękę. W końcu przemieszczą się gdzie indziej w poszukiwaniu zwierzyny i miejsc do plądrowania.";
	}
