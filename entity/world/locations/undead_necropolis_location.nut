this.undead_necropolis_location <- this.inherit("scripts/entity/world/location", {
	...
	{
		return "Niegdyś kwitnąca ludzka osada, która została splugawiona i popadła w ruinę, przemieniła się w nekropolię nieumarłych. Fale chodzących trupów przelewają się przez nią, by szerzyć terror i strach po okolicznych ziemiach.";
	}
	...
	function setName( _n )
	{
		...
		this.world_entity.setName("Ruiny " + _n);
	}
