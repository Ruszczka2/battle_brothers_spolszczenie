this.dye_maker_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Wytwórca Barwników";
		this.m.ID = "attached_location.dye_maker";
		this.m.Description = "Ten wytwórca barwników tworzy cenne barwniki z różnego rodzaju składników. Przepisy na te drogocenne towary są dobrze strzeżoną tajemnicą.";
