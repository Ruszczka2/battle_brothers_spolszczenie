this.militia_trainingcamp_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Koszary Milicji";
		this.m.ID = "attached_location.militia_trainingcamp";
		this.m.Description = "Duzy kompleks koszar milicji. Ten obóz zamieni zwykłych chłopów w dość umiejętnych żołnierzy, którzy mogą chronić swoich domów i bliskich im osób.";
