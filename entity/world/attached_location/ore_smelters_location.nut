this.ore_smelters_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Wytapiacze Rudy";
		this.m.ID = "attached_location.ore_smelters";
		this.m.Description = "Rozpalone do czerwoności piece hutnicze produkują wysokiej jakości metalowe sztabki, używane przez zdolnych zbrojmistrzów do wytwarzania najwyższej klasy oręża.";
