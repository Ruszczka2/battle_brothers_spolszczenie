this.gatherers_hut_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Chatka Zbieracza";
		this.m.ID = "attached_location.gatherers_hut";
		this.m.Description = "Nawet w jałowych środowiskach doświadczony zbieracz jest w stanie znaleźć jagody, korzenie i inne jadalne rzeczy. Mimo iż nie są to smakołyki, nadal potrafią wyżywić człowieka.";
