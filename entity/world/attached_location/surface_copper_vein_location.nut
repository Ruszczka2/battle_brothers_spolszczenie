this.surface_copper_vein_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Odkryta Żyła Miedzi";
		this.m.ID = "attached_location.surface_copper_vein";
		this.m.Description = "Obóz górniczy został tu utworzony, aby wydobywać przypowierzchniową miedź i na miejscu przetapiać rudę w sztabki.";
