this.hunters_cabin_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Chatka Myśliwego";
		this.m.ID = "attached_location.hunters_cabin";
		this.m.Description = "Myśliwi szukają schronienia w tych małych chatkach podczas polowań. Poćwiartowana zwierzyna, kawały dziczyzny i skóry wiszą dookoła chaty, aby wyschnąć na słońcu.";
