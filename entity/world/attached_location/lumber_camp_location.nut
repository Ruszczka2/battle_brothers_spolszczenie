this.lumber_camp_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Obóz Drwali";
		this.m.ID = "attached_location.lumber_camp";
		this.m.Description = "Ten obóz drwali służy za bazę wypadową dla rębaczy poszukujących w okolicznych lasach najcenniejszego i najtrwalszego budulca.";
