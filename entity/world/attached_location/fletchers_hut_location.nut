this.fletchers_hut_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Szopa Strzałoroba";
		this.m.ID = "attached_location.fletchers_hut";
		this.m.Description = "Wytwórcy strzał produkują w tych szopach wszelkiego rodzaju amunicję dystansową, która później sprzedają w pobliskiej osadzie.";
