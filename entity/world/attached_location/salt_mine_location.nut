this.salt_mine_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Kopalnia Soli";
		this.m.ID = "attached_location.salt_mine";
		this.m.Description = "Kopalnia, w której cenna sól kamienna jest pozyskiwana i z której wysyłana jest tylko do najbardziej godnych zaufania kupców.";
