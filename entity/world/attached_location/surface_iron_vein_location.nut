this.surface_iron_vein_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Odkryta Żyła Żelaza";
		this.m.ID = "attached_location.surface_iron_vein";
		this.m.Description = "Ta wynurzona żyła żelaza przyciągnęła mały obóz górniczy, który pozyskuje cenny metal. Dostęp do tego zasobu zwiększa wybór broni u rzemieślników w pobliskiej osadzie.";
