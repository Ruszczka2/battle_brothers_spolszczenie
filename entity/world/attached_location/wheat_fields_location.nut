this.wheat_fields_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Pola Pszenicy";
		this.m.ID = "attached_location.wheat_fields";
		this.m.Description = "Złocista pszenica z oddala mieni się w świetle słońca. Pracuje tu wielu ludzi z pobliskiej osady, głównie parobkowie i robotnicy.";
