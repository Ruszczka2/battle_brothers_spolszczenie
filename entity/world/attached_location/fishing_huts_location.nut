this.fishing_huts_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Chaty Rybackie";
		this.m.ID = "attached_location.fishing_huts";
		this.m.Description = "Mała grupka chat otoczona przez sieci, włócznie, harpuny i inny rybacki sprzęt. Smród z koszy wypełnionych rybimi wnętrznościami rozlega się po okolicy.";
