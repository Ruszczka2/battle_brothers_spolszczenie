this.plantation_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Plantacja";
		this.m.ID = "attached_location.plantation";
		this.m.Description = "Wszelkiego rodzaju cudowne przyprawy i zioła są uprawiane na tej plantacji. Mały i rzadki owocny zakątek na jałowej pustyni.";
