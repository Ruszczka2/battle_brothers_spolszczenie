this.pig_farm_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Farma Świń";
		this.m.ID = "attached_location.pig_farm";
		this.m.Description = "Zapach tej farmy świń jest równie wyróżniający się, co donośne kwiczenie wydobywające się z błotnistych dołów. Produkowany tutaj schab zazwyczaj sprzedawany jest w pobliskiej osadzie.";
