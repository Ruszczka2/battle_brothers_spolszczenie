this.workshop_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Warsztat";
		this.m.ID = "attached_location.workshop";
		this.m.Description = "Warsztat biegły jest w tworzeniu wszelakich narzędzi i innych zapasów, które wymagane są, aby wozy i różnorakie machiny działały dalej.";
