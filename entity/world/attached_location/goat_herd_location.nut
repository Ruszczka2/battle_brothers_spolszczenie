this.goat_herd_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Zagrody Kóz";
		this.m.ID = "attached_location.goat_herd";
		this.m.Description = "Trzymane tutaj kozy wykorzystuje się głównie do pozyskiwania mleka, które później zamieniane jest w znacznie bardziej trwały ser.";
