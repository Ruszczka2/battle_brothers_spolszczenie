this.gem_mine_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Kopalnia Klejnotów";
		this.m.ID = "attached_location.gem_mine";
		this.m.Description = "Znalezione w tych kopalniach kamienie szlachetne są zwykle wysyłane bezpośrednio do najbliższej osady w dobrze strzeżonych karawanach w celu dalszej obróbki.";
