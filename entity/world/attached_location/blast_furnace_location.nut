this.blast_furnace_location <- this.inherit("scripts/entity/world/attached_location", {
	...
	function create()
	{
		...
		this.m.Name = "Wielki Piec";
		this.m.ID = "attached_location.blast_furnace";
		this.m.Description = "Wielki piec wytwarza potężne temperatury, które konieczne są do otrzymania najbardziej wytrzymałych stopów metalu. Zdolni płatnerze w pobliskiej osadzie wykorzystają te stopy do stworzenia solidnych pancerzy.";
