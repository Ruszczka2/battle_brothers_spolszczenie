this.world_active_contract_panel_module <- this.inherit("scripts/ui/screens/ui_module", {
	...
	{
		this.World.State.showDialogPopup("Anuluj Kontrakt", "Anulowanie aktywnego kontraktu niekorzystnie wpłynie nie tylko na twoją reputację jako najemnika, ale też i na relacje z twoim obecnym pracodawcą - zwłaszcza, jeśli część zapłaty była z góry.\n\nCzy na pewno chcesz anulować kontrakt?", this.onContractCancelled.bindenv(this), null);
	}
