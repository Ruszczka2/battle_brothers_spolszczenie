this.voice_of_davkul_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "Ta postać usłyszała głos Davkula przemawiający prawdziwie przez jej cielesną powłokę. Jest gotowa przejść samą siebie i pokonać swoje fizyczne słabości, by wykonać wolę swego boga.";
