this.net_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "Wielka sieć trzyma tę postać w miejscu i krępuje jej zdolność do obrony. Aby się uwolnić, sieć musi zostać rozcięta.";
	...
	function getTooltip()
	{
		return [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-45%[/color] do Obrony w zwarciu"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/ranged_defense.png",
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-45%[/color] do Obrony dystansowej"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/initiative.png",
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-45%[/color] do Inicjatywy"
			}
		];
	}
