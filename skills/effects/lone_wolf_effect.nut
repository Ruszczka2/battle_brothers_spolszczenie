this.lone_wolf_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "Najlepiej mi się pracuje w samotności.";
	...
	function getTooltip()
	{
		return [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.PositiveValue + "]+15%[/color] do Ataku w zwarciu"
			},
			{
				id = 10,
				type = "text",
				icon = "ui/icons/ranged_skill.png",
				text = "[color=" + this.Const.UI.Color.PositiveValue + "]+15%[/color] do Ataku dystansowego"
			},
			{
				id = 10,
				type = "text",
