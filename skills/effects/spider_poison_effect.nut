this.spider_poison_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Zatruty";
		this.m.KilledString = "Umarł od trucizny";
	...
	{
		return "W żyłach tej postaci płynie paskudna trucizna, powodująca utratę [color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.Damage + "[/color] punktów zdrowia na turę, a efekt utrzyma się jeszcze przez [color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color] " + (this.m.TurnsLeft > 1 ? "tury" : "turę") + ".";
	}
