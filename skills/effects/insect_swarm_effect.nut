this.insect_swarm_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Tysiące czarnych much brzęczy wokół tej postaci, próbując wpełznąć w każdą szczelinę pancerza i każdy otwór ciała. Straszliwa klątwa, która niemalże całkowicie uniemożliwi tej postaci walkę przez jeszcze [color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color] " + (this.m.TurnsLeft > 1 ? "tury" : "turę") + ".";
	}
