this.disarmed_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Ta postać została tymczasowo rozbrojona i jeszcze przez [color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color] " + (this.m.TurnsLeft > 1 ? "tury" : "turę") + " nie będzie w stanie używać broni i związanych z nią umiejętności. Zmiana na inną broń natychmiast usunie ten efekt.";
	}
	...
	{
		return _user + " rozbraja: " + _victim + " na " + this.getEffectDurationString();
	}
