this.charmed_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Na tę postać rzucono urok. Nie ma już ona kontroli nad swymi własnymi czynami i jest zaledwie marionetką, zmuszoną słuchać swego mistrza. Czar pryśnie za [color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color] " + (this.m.TurnsLeft > 1 ? "tury" : "turę") + ".\n\nIm wyższa stanowczość postaci, tym większa szansa na odparcie uroku.";
	}
