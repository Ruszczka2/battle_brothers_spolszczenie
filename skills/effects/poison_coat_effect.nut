this.poison_coat_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Broń pokryta trucizną";
	...
	{
		return "Ta postać używa broni pokrytej trucizną. Następne kilka trafień zadających co najmniej [color=" + this.Const.UI.Color.NegativeValue + "]" + this.Const.Combat.PoisonEffectMinDamage + "[/color] obrażeń zdrowia zaaplikuje truciznę ofierze. Zatrute cele mają przymglony wzrok i ciężko im koordynować ruchy, póki organizm sam nie zneutralizuje toksyn.";
	}
