this.hex_slave_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Klątwa";
		this.m.KilledString = "Zmarł od klątwy";
	...
	{
		return "Ta postać została przeklęta, aby odczuwać ten sam ból i otrzymywać te same rany, co inna osoba. Ostrożnie, gdyż to może ją zabić. Ten efekt utrzyma się jeszcze przez [color=" + this.Const.UI.Color.NegativeValue + "]1[/color] turę.";
	}
