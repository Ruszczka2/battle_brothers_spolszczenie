this.distracted_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Ta postać padła ofiarą podłej sztuczki. Będąc rozkojarzona jeszcze przez [color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color] " + (this.m.TurnsLeft > 1 ? "tury" : "turę") + ", wolniej będzie reagować na sytuację na polu bitwy i trudniej jej będzie zadać czyste trafienia.";
	}
	...
	function getTooltip()
	{
		return [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-35%[/color] do zadawanych obrażeń"
			},
			{
				id = 12,
				type = "text",
