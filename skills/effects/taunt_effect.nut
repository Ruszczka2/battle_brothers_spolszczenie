this.taunt_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Szyderca";
		this.m.Description = "Ta postać przykuła na sobie uwagę pobliskich przeciwników i jest bardziej narażona na ich ataki, niż inne potencjalne cele.";
