this.spider_poison_coat_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Broń pokryta jadem";
	...
	{
		return "Ta postać używa broni pokrytej skoncentrowanym jadem webknechta. Następne kilka trafień zadających co najmniej [color=" + this.Const.UI.Color.NegativeValue + "]" + this.Const.Combat.PoisonEffectMinDamage + "[/color] obrażeń zdrowia zaaplikuje jad ofierze. Zatrute cele będą tracić [color=" + this.Const.UI.Color.NegativeValue + "]10[/color] punktów zdrowia na turę, aż do ustania efektu.";
	}
	...
	function onTargetHit( _skill, _targetEntity, _bodyPart, _damageInflictedHitpoints, _damageInflictedArmor )
	{
		...
		if (!_targetEntity.isHiddenToPlayer())
		{
			...
			this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_targetEntity) + " ulega zatruciu");
		}
