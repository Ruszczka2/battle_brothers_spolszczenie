this.captain_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Natchniony przez Pobliskiego Przywódcę";
		this.m.Description = "Z kapitanem w pobliżu, który daje rady i inspiruje, ta postać tymczasowo ma zwiększoną Stanowczość.";
