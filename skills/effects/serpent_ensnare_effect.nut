this.serpent_ensnare_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "Ta postać została oplątana przez ogromnego węża. Każdej tury wąż może próbować zmiażdżyć postać, zacieśniając chwyt, co spowoduje utratę [color=" + this.Const.UI.Color.NegativeValue + "]10[/color] punktów zdrowia.";
