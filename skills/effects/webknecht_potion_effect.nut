this.webknecht_potion_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Zmutowany Układ Krwionośny";
	...
	{
		return "Ciało tej postaci uległo mutacji i znacznie wolniej rozprzestrzenia trucizny oraz inne niebezpieczne substancje w krwioobiegu, dzięki czemu organizm jest w stanie się ich pozbyć bez poważnych skutków zdrowotnych. Co ciekawe, nie wydaje się to mieć wpływu na zdolność do upijania się.";
	}
