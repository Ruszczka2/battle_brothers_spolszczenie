this.kraken_potion_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Ta postać czerpie moc z jakiegoś niewyczerpalnego źródła, mając wytrzymałość dwóch rosłych chłopów. Udajesz, że nie zauważasz wypatroszonych zwłok, które czasami znajdujesz w jej pobliżu.";
	}
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.PositiveValue + "]+50[/color] do Zdrowia"
			},
			{
				id = 12,
				type = "hint",
