this.holy_water_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Spryskany Święconą Wodą";
	...
	function onAdded()
	{
		...
		{
			this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(this.getContainer().getActor()) + " zostaje spryskany Święconą Wodą");
		}
