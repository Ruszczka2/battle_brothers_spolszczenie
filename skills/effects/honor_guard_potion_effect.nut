this.honor_guard_potion_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Skóra oraz tkanka podskórna tej postaci zmutowały i będą się gwałtownie zrastać. Efekt jest najbardziej widoczny na niewielkich nakłuciach, gdyż ciało może zasklepić ranę równomiernie ze wszystkich kierunków.";
	}
