this.night_vision_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Widzenie w Ciemności";
	...
	{
		return "Dzięki pewnemu alchemicznemu cudeńku, dla tej postaci noc stała się jasna niczym dzień.";
	}
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "Niewrażliwy na kary od nocy"
			},
			{
				id = 7,
				type = "hint",
