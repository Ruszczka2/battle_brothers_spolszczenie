this.battle_standard_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Za kompanię!";
		this.m.Description = "Ze wspaniałą chorągwią kompanii w pobliżu, ta postać czuje się zobowiązana do ruszenia naprzód i plucia w twarz niebezpieczeństwu.";
	...
	function getTooltip()
	{
		...
		return [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.PositiveValue + "]+" + bonus + "[/color] do Stanowczości"
			}
		];
	}
