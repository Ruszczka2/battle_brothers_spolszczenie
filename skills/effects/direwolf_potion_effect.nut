this.direwolf_potion_effect <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Elastyczne Ścięgna";
	...
	{
		return "Mięśnie tej postaci zmutowały i reagują inaczej na impulsy ruchowe. W rezultacie, przerwanie lub zatrzymanie ruchu w połowie jest o wiele mniej męczące, dzięki czemu o wiele łatwiej jest odzyskać równowagę po chybionych lub zablokowanych atakach.";
	}
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "Zadane ataki, które chybią, generują o [color=" + this.Const.UI.Color.PositiveValue + "]50%[/color] mniej Zmęczenia"
			},
			{
				id = 12,
				type = "hint",
