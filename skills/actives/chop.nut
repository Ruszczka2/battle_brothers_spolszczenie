this.chop <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Rąb";
		this.m.Description = "Potężny rąbiący atak, który spada na cel z ogromną siłą.";
		this.m.KilledString = "Zarąbany";
		...
		ret.extend([
			{
				...
				text = "Zadaje dodatkowe [color=" + this.Const.UI.Color.PositiveValue + "]50%[/color] obrażeń przy trafieniu w głowę"
			}
		]);
		return ret;
	}
