this.fling_back_skill <- this.inherit("scripts/skills/skill", {
	...
	function onPerformAttack( _tag )
	{
		...
		{
			this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " przerzuca za siebie: " + this.Const.UI.getColorizedEntityName(target));
		}
