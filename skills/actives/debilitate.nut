this.debilitate <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Przygotuj swój następny atak, aby osłabić wroga na jedną turę, obniżając jego zdolność do zadawania obrażeń o  [color=" + this.Const.UI.Color.NegativeValue + "]-50%[/color]. Spudłowanie spowoduje utratę przygotowanego efektu.";
	}
