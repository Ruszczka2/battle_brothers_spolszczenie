this.split_man <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Rozłup Człowieka";
		this.m.Description = "Powolny atak znad głowy, wyprowadzony z pełną siłą, aby rozłupać cel na pół. Ma w sobie tyle mocy, że zawsze trafia zarówno głowę, jak i ciało dla dodatkowych obrażeń.";
		this.m.KilledString = "Rozłupany na pół";
	...
	function getTooltip()
	{
		...
		else
		{
			ret.push({
				...
				type = "text",
				icon = "ui/icons/regular_damage.png",
				text = "Zadaje [color=" + this.Const.UI.Color.DamageValue + "]" + damage_regular_min + "[/color] - [color=" + this.Const.UI.Color.DamageValue + "]" + damage_regular_max + "[/color] obrażeń zdrowia"
			});
		}
		...
		ret.push({
			...
			text = "Trafia zarówno głowę, jak i ciało dla dodatkowych obrażeń"
		});
		return ret;
	}
