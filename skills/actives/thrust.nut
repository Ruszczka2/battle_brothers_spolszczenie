this.thrust <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Pchnij";
		this.m.Description = "Dobrze wymierzone pchnięcie, przed którym ciężko się uchylić lub je zablokować.";
		this.m.KilledString = "Nadziany";
		...
		ret.extend([
			{
				...
				text = "Ma [color=" + this.Const.UI.Color.PositiveValue + "]+20%[/color] szansy na trafienie"
			}
		]);
		return ret;
	}
