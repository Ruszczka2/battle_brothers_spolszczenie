this.adrenaline_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "Poczuj adrenalinę pędzącą w twoich żyłach i napędzającą cie do szybszego działania. Będziesz w stanie wykonać swój ruch szybciej niż przeciwnik.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "Umieszcza tę postać na przodzie kolejki tur następnej rundy"
			}
		];
		return ret;
	}
