this.possess_undead_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Opętaj Nieumarłego";
		this.m.Description = "";
	...
	function onUse( _user, _targetTile )
	{
		...
		{
			this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " opętuje: " + this.Const.UI.getColorizedEntityName(target));
