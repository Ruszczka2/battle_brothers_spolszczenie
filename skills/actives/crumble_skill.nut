this.crumble_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Zgnieć";
		this.m.Description = "Mocne uderzenie, aby zgnieść formację wroga. Może pokryć odległość 2 pól i można go użyć zza przedniej linii, będąc poza zasięgiem większości broni białej.";
