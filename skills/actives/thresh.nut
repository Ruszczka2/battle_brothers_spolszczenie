this.thresh <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Wymłóć";
		this.m.Description = "Wymłóca wszystkie cele wokół ciebie, tak wrogów, jak i przyjaciół, szaleńczym okrężnym zamachem.Nietrudno uniknąć tego ciosu, bo nie jest mierzone w nic konkretnego, choć może być druzgocące, jeżeli trafi. Ma szansę na ogłuszenie trafionych celów na jedną turę. Ostrożnie z używaniem tej zdolności w pobliżu własnych ludzi, chyba że chcesz zmniejszyć swoją listę płac!";
		this.m.KilledString = "Zamłócony";
