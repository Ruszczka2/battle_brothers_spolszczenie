this.prong_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Dźgnij";
		this.m.Description = "Pchnięcie, które może sięgnąć aż na 2 pola i którego można użyć zza przedniego szeregu, pozostając poza zasięgiem większości broni białej.";
		this.m.KilledString = "Zadźgany";
