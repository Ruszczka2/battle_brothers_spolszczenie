this.fire_mortar_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Wystrzel z Moździerza";
		this.m.Description = "";
		this.m.KilledString = "Rozleciał się na kawałki";
	...
	function onUse( _user, _targetTile )
	{
		...
		{
			this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " wystrzeliwuje pocisk wysoko w powietrze");
		}
	...
	{
		this.Tactical.EventLog.log("Pocisk moździerza uderza w pole bitwy");
