this.reload_bolt <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Przeładuj";
		this.m.Description = "Przygotuj kolejny bełt do wystrzelenia. Umiejętność nie może być użyta, gdy postać sąsiaduje z wrogiem walczącym wręcz.";
	...
	function getTooltip()
	{
		...
		else
		{
			ret.push({
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]Wymaga założonego kołczanu bełtów, który nie jest pusty[/color]"
			});
		}
