		...
		for( local i = 0; i < 6; i = i )
		{
			...
			else
			{
				...
				else if (tile.IsVisibleForPlayer)
				{
					...
					{
						this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " pożera: " + this.Const.UI.getColorizedEntityName(tile.getEntity()));
					}
