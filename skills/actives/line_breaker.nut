this.line_breaker <- this.inherit("scripts/skills/skill", {
	...
	function onUse( _user, _targetTile )
	{
		...
		{
			this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " przedziera się przez: " + this.Const.UI.getColorizedEntityName(target));
		}
