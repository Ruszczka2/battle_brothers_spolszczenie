this.decapitate <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Dekapitacja";
		this.m.Description = "Niszczycielski cios, aby z miejsca zdekapitować cel. Zadaje tym więcej obrażeń zdrowia, im bardziej cel jest ranny. Zabicie celu zawsze zakończy się ścięciem głowy, o ile jest to możliwe.";
	...
	function getTooltip()
	{
		...
		ret.push({
			...
			text = "Zadaje [color=" + this.Const.UI.Color.DamageValue + "]" + damage_regular_min + "[/color] - [color=" + this.Const.UI.Color.DamageValue + "]" + damage_regular_max * 2 + "[/color] obrażeń w zależności od tego, jak bardzo ranny jest cel, z czego [color=" + this.Const.UI.Color.DamageValue + "]0[/color] - [color=" + this.Const.UI.Color.DamageValue + "]" + damage_direct_max + "[/color] może zignorować pancerz"
		});
