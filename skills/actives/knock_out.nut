this.knock_out <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Ogłusz";
		this.m.Description = "Mocny cios, którego zamiarem jest ogłuszyć lub obezwładnić na jedną turę przeciwnika, a nie zadać jak największe obrażenia. Ogłuszone cele nie są w stanie utrzymać swojej Ściany Tarcz, Ściany Włóczni, ani innych podobnych umiejętności defensywnych.";
