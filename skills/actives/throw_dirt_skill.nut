this.throw_dirt_skill <- this.inherit("scripts/skills/skill", {
	...
	function onUse( _user, _targetTile )
	{
		...
		{
			this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " rzuca piachem w twarz, przez co " + this.Const.UI.getColorizedEntityName(_targetTile.getEntity()) + " jest zdekoncentrowany");
		}
