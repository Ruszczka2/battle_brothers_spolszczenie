this.riposte <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Riposta";
		this.m.Description = "Przygotuj się do natychmiastowego skontratakowania każdego wroga, który zaatakuje cię w zwarciu i chybi.";
	...
	function onUse( _user, _targetTile )
	{
		if (!this.m.IsSpent)
		{
			...
			{
				this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " używa Riposty");
			}
