this.coat_with_spider_poison_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Użyj Zatrutego Olejku";
		this.m.Description = "Pokryj swoją broń i groty trucizną. Umiejętność nie może być użyta, gdy postać sąsiaduje z wrogiem walczącym wręcz.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "Kolejne [color=" + this.Const.UI.Color.PositiveValue + "]4[/color] ataki będą zatruwać cele, zadając im [color=" + this.Const.UI.Color.NegativeValue + "]10[/color] obrażeń co turę."
			}
		];
