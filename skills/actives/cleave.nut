this.cleave <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Siecz";
		this.m.Description = "Brutalny sieczący atak, który może zadać krwawiące rany, jeśli cel nie zostanie osłonięty przez pancerz i w ogóle jest w stanie krwawić.";
		this.m.KilledString = "Zasieczony";
	...
	function getTooltip()
	{
		...
		ret.push({
			...
			text = "Zadaje dodatkowe, kumulujące się [color=" + this.Const.UI.Color.DamageValue + "]" + dmg + "[/color] obrażeń od krwawienia na turę, na 2 tury"
		});
		return ret;
	}
