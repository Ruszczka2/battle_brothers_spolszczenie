this.footwork <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Praca Nóg";
		this.m.Description = "Użyj umiejętnej pracy nóg, aby opuścić czyjąś Strefę Kontroli nie wyzwalając darmowych okazyjnych ataków.";
	...
	function getTooltip()
	{
		...
		if (this.Tactical.isActive() && !this.getContainer().getActor().getTile().hasZoneOfControlOtherThan(this.getContainer().getActor().getAlliedFactions()))
		{
			ret.push({
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]Można użyć tylko będąc w Strefie Kontroli przeciwnika[/color]"
			});
		}
