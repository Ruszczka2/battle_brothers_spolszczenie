this.puncture <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Przekłuj";
		this.m.Description = "Dobrze umiejscowiony atak w słaby punkt w pancerzu przeciwnika. Całkowicie ignoruje pancerz, jednak trudniej nim trafić, nigdy nie zada obrażeń krytycznych i nie otrzymuje premii do obrażeń od trzymania broni oburącz.";
	...
	function getTooltip()
	{
		...
		ret.extend([
			...
			},
			{
				...
				text = "Całkowicie ignoruje pancerz"
			}
		]);
		return ret;
	}
