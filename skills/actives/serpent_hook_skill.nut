this.serpent_hook_skill <- this.inherit("scripts/skills/skill", {
	...
	function onUse( _user, _targetTile )
	{
		...
		{
			this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " przyciąga do siebie: " + this.Const.UI.getColorizedEntityName(_targetTile.getEntity()));
		}
