this.lightning_storm_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Uderzenie Pioruna";
		this.m.Description = "";
		this.m.KilledString = "Porażony piorunem";
	...
	function onUse( _user, _targetTile )
	{
		...
		{
			this.Tactical.EventLog.log(this.Const.UI.getColorizedEntityName(_user) + " przyzywa piorun");
		}
	...
	{
		this.Tactical.EventLog.log("Piorun uderza w pole bitwy");
