this.deathblow_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Zabójczy Cios";
		this.m.Description = "Zadaj zabójczy cios osłabionemu celowi, aby go dobić.";
		this.m.KilledString = "Zasztyletowany";
	...
	function getTooltip()
	{
		...
		ret.push({
			...
			text = "Zadaje [color=" + this.Const.UI.Color.DamageValue + "]33%[/color] więcej obrażeń i ignoruje dodatkowe [color=" + this.Const.UI.Color.DamageValue + "]20%[/color] pancerza celów, które są Ogłuszone, Oszołomione lub uwięzione w sieci."
		});
		return ret;
	}
