this.fractured_ribs_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Pęknięte Żebra";
		this.m.Description = "Pęknięte żebra z każdym oddechem wysyłają falę bólu po całym ciele.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-30%[/color] maksymalnego zmęczenia"
			}
		];
