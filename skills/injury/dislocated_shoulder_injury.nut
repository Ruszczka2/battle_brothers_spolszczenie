this.dislocated_shoulder_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Zwichnięte Ramię";
		this.m.Description = "Potężny cios wybił ramię ze stawu, przez co ciężko w ogóle ruszać ręką.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-3[/color] Punkty Akcji"
			}
		];
