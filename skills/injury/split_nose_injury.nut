this.split_nose_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Rozcięty Nos";
		this.m.Description = "Bliskie cięcie rozpłatało nos tej postaci na dwoje, przez co każda próba wzięcia oddechu jest ćwiczeniem w połykaniu pokaźnych ilości krwi.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-5[/color] odnowy Zmęczenia na turę"
			}
		];
