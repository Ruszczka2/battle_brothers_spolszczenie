this.stabbed_guts_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Dźgnięte Bebechy";
		this.m.Description = "Rana otrzymana w jelita obniża wytrzymałość, a spora szansa wdania się infekcji i widmo powolnej, bolesnej śmierci wcale nie pomagają.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-40%[/color] do Zdrowia"
			},
			{
				id = 7,
				type = "text",
