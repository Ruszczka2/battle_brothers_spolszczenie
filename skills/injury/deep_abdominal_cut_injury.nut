this.deep_abdominal_cut_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Głęboka Rana Brzuszna";
		this.m.Description = "Głęboka rana cięta na brzuchu, która uszkodziła mięśnie i przez którą wszelki ruch lub nawet stanie prosto są bolesne, obniża wytrzymałość tej postaci.";
