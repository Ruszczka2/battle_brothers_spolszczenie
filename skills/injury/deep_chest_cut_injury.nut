this.deep_chest_cut_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Głęboka Rana Klatki Piersiowej";
		this.m.Description = "Głęboka, krwawiąca rana, która rozcięła klatkę i mięsień piersiowy sprawia, że ciężko ustać się na nogach, a co dopiero utrzymać broń.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-35%[/color] do Zdrowia"
			},
			{
				id = 7,
				type = "text",
				icon = "ui/icons/fatigue.png",
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-35%[/color] maksymalnego zmęczenia"
			},
			{
				id = 6,
				type = "text",
				icon = "ui/icons/melee_skill.png",
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-35%[/color] do Ataku w zwarciu"
			},
			{
				id = 7,
				type = "text",
				icon = "ui/icons/ranged_skill.png",
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-35%[/color] do Ataku dystansowego"
			}
		];
