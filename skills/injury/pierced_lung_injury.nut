this.pierced_lung_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Przebite Płuco";
		this.m.Description = "Dodatkowy otwór oddechowy na niewiele się przydaje, poza tym, że brzmi jak dudy.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-60%[/color] maksymalnego zmęczenia"
			}
		];
