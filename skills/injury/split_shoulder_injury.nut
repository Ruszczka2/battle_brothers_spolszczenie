this.split_shoulder_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Rozłupane Ramię";
		this.m.Description = "Głębokie cięcie rozłupało ramię tej postaci, rozcinając tkankę mięśniową i znacznie ograniczając mobilność rąk.";
