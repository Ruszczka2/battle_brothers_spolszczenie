this.fractured_skull_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Pęknięta Czaszka";
		this.m.Description = "Czaszka tej postaci ma liczne pęknięcia, a mózg dostał wstrząsu, przez co napuchł i powoduje ucisk wewnątrz czaszki.";
