this.pierced_side_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Przebity Bok";
		this.m.Description = "Atak kłuty przeszył bok, naruszył tkankę mięśniową i żebra. Mimo iż żaden istotny organ nie ucierpiał, to i tak nawet samo oddychanie jest bolesne.";
