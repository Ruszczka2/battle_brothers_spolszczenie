this.burnt_hands_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Poparzone Dłonie";
		this.m.Description = "Poparzone dłonie znacznie ograniczają zdolność do wykonywania szybkich i precyzyjnych ruchów. Do tego piecze to jak cholera.";
