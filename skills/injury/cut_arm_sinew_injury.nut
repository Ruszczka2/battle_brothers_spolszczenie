this.cut_arm_sinew_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Przecięte Ścięgna Ręki";
		this.m.Description = "Częściowo przecięte ścięgna ręki sprawiają, że trudno jest przyłożyć się do zadania ciosu.";
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]-40%[/color] do zadawanych obrażeń"
			}
		];
