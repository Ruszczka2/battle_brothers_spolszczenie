this.grazed_eye_socket_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Name = "Zraniony Oczodół";
		this.m.Description = "Cios naruszył i zerwał tkankę blisko oka, przez co naszło ono krwią, a powieka napuchła całkowicie je zamykając.";
