this.anatomist_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.GoodEnding = "Ze wszystkich ludzi, których poznałeś w %companyname%, to %name%, anatom, jest chyba najtrudniejszy do zapomnienia. Niekończący się strumień listów tylko upewnia cię, że nigdy go nie zapomnisz. Przerzucasz jego najnowszą, jednostronną korespondencję: \"Kapitanie! Udało mi się...\" przerzucasz, przerzucasz, \"...największy wynalazek! Najbardziej...\" przerzucasz, przerzucasz. \"Zostanę sławny! Mój mózg będzie badany, bo jego waga z pewnością...\" Nic nowego, jak widać, choć cieszysz się, że wciąż jest w dobrym zdrowiu, choć może bardziej ciała niż umysłu.";
		this.m.BadEnding = "Po ucieczce z %companyname% %name%, anatom, kontynuował badania gdzie indziej. Upomniany przez rówieśników za tak nieokrzesane obyczaje, ugrzązł w intelektualnej przeciętności. Kilka lat później wniósł drobny wkład w badania nad chrząszczami, po czym bez wahania rzucił się z nadmorskiego klifu, ofiarowując mózg skałom, a ciało oceanowi.";
