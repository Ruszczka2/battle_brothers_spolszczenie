this.orc_slayer_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	{
		return "%name% niewiele o sobie mówi. Chce tylko zabijać orki i gobliny, przez co, zważając na obecną sytuację, idealnie nadaje się do kompanii. Jeśli dotrzyma słowa, opuści nas, gdy tylko inwazja zostanie zażegnana.";
	}
