this.crusader_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	{
		return "%name% dołączył do twojej kompanii podczas plagi nieumarłych. Niewiele o nim wiadomo i prawie nigdy się nie odzywa, pomijając jego okazjonalne burknięcia podczas machania mieczem. Jego język zdaje się kodyfikować w jedną prostą rzecz: zabijanie plugawych istot.";
	}
