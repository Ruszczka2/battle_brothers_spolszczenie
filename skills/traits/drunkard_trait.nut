this.drunkard_trait <- this.inherit("scripts/skills/traits/character_trait", {
	...
	function create()
	{
		...
		this.m.Name = "Moczymorda";
		this.m.Icon = "ui/traits/trait_icon_29.png";
		this.m.Description = "Nie ma wątpliwości na co ta postać wydaje swe korony. Spodziewaj się, że przed każdą bitwą porządnie się schleje, nawet jeśli będzie to musiała robić po kryjomu.";
		this.m.Titles = [
			"Pijak",
			"Moczymorda"
		];
	...
	function getTooltip()
	{
		return [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] do zadawanych obrażeń"
			},
			{
				id = 11,
				type = "text",
