this.fat_trait <- this.inherit("scripts/skills/traits/character_trait", {
	...
	function create()
	{
		...
		this.m.Description = "Ta postać jest bardziej zainteresowana kotletami wieprzowymi, niż ćwiczeniami, i dość szybko się męczy.";
		this.m.Titles = [
			"Gruby",
			"Wół",
			"Góra",
	...
	function getTooltip()
	{
		return [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.PositiveValue + "]+10[/color] do Zdrowia"
			},
			{
				id = 11,
				type = "text",
