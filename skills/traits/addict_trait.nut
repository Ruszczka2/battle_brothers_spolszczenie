this.addict_trait <- this.inherit("scripts/skills/traits/character_trait", {
	...
	function create()
	{
		...
		this.m.Name = "Uzależnienie";
		this.m.Icon = "ui/traits/trait_icon_62.png";
		this.m.Description = "Ta postać rozwinęła w sobie uzależnienie od pewnej substancji. Jeśli nie będzie jej dostawała regularnie, mogą pojawić się symptomy odstawienia.";
		this.m.Excluded = [];
	}
	...
	function getTooltip()
	{
		...
		else
		{
			ret.push({
				...
				text = "Obecnie brak efektu, gdyż narkotyk zażyto w ciągu ostatnich 5 dni"
			});
		}
