this.cultist_disciple_trait <- this.inherit("scripts/skills/traits/character_trait", {
	...
	function create()
	{
		...
		this.m.Name = "Apostoł Davkul";
		this.m.Icon = "ui/traits/trait_icon_67.png";
		this.m.Description = "Ta postać jest apostołem Davkula, jednostką o niekwestionowanej lojalności wobec wiekowego boga. Z radością wita ból fizyczny i niebezpieczeństwa, gdyż zbliżają ją one do zbawienia.";
