this.perk_reach_advantage <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Ta postać wykorzystuje przewagę zasięgu swojej broni białej, aby utrzymać przeciwników na dystans, zwiększając swoją Obronę w Zwarciu o [color=" + this.Const.UI.Color.PositiveValue + "]+" + this.m.Stacks * 5 + "[/color] do następnej swojej tury.";
	}
