this.perk_fast_adaption <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Ta postać szybko dostosowuje się do ruchów przeciwnika i zyskuje dodatkowe [color=" + this.Const.UI.Color.PositiveValue + "]+" + this.m.Stacks * 10 + "%[/color] szans na trafienie przy dowolnym ataku.";
	}
