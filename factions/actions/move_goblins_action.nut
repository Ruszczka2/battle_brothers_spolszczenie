this.move_goblins_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		{
			local party = this.getFaction().spawnEntity(this.m.Start.getTile(), "Gobliny", false, this.Const.World.Spawn.GoblinRaiders, this.Math.rand(70, 130) * this.getScaledDifficultyMult());
