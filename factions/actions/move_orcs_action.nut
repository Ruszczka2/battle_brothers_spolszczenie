this.move_orcs_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		{
			local party = this.getFaction().spawnEntity(this.m.Start.getTile(), "Orkowie", false, this.Const.World.Spawn.OrcRaiders, this.Math.rand(70, 130) * this.getScaledDifficultyMult());
