this.defend_militia_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		for( local i = 0; i != spawnpoints.len(); i = i )
		{
			...
			local party = _faction.spawnEntity(spawnpoints[i], "Milicja z " + this.m.Settlement.getName(), false, this.Const.World.Spawn.Militia, this.m.Settlement.getResources());
