this.move_troops_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		{
			local party = this.getFaction().spawnEntity(this.m.Start.getTile(), "Kompania " + this.m.Start.getName(), true, this.Const.World.Spawn.Noble, this.Math.rand(100, 300) * this.getReputationToDifficultyLightMult());
