this.send_military_army_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		{
			local party = this.getFaction().spawnEntity(spawnpoints[i], "Kompania " + origin.getName(), true, this.Const.World.Spawn.Noble, this.Math.rand(80, 120) * this.getScaledDifficultyMult());
