this.move_undead_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		{
			local party = _faction.spawnEntity(this.m.Start.getTile(), "Nieumarli", false, this.Const.World.Spawn.UndeadScourge, this.Math.rand(70, 130) * this.getReputationToDifficultyLightMult());
