this.send_undead_army_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		local party = this.World.FactionManager.getFactionOfType(this.Const.FactionType.Undead).spawnEntity(myTile, "Nieumarli", false, this.Const.World.Spawn.UndeadScourge, this.Math.rand(80, 120) * this.getScaledDifficultyMult());
