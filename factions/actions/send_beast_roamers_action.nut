this.send_beast_roamers_action <- this.inherit("scripts/factions/faction_action", {
	...
	function create()
	{
		...
		beast = function ( _action, _nearTile = null )
		{
			...
			local party = _action.getFaction().spawnEntity(tile, "Nachzehrery", false, this.Const.World.Spawn.Ghouls, this.Math.rand(80, 120) * _action.getScaledDifficultyMult() * this.Math.maxf(0.7, this.Math.minf(1.5, distanceToNextSettlement / 14.0)));
		...
		beast = function ( _action, _nearTile = null )
		{
			...
			local distanceToNextSettlement = _action.getDistanceToSettlements(tile);
			local party = _action.getFaction().spawnEntity(tile, "Wilkory", false, this.Const.World.Spawn.Direwolves, this.Math.rand(80, 120) * _action.getScaledDifficultyMult() * this.Math.maxf(0.7, this.Math.minf(1.5, distanceToNextSettlement / 14.0)));
			party.getSprite("banner").setBrush("banner_beasts_01");
			party.setDescription("Wataha zaciekłych wilkorów polujących na zwierzynę.");
		...
		if (this.Const.DLC.Desert)
		{
			beast = function ( _action, _nearTile = null )
			{
				...
				local distanceToNextSettlement = _action.getDistanceToSettlements(tile);
				local party = _action.getFaction().spawnEntity(tile, "Hieny", false, this.Const.World.Spawn.Hyenas, this.Math.rand(80, 120) * _action.getScaledDifficultyMult() * this.Math.maxf(0.7, this.Math.minf(1.5, distanceToNextSettlement / 14.0)));
				party.getSprite("banner").setBrush("banner_beasts_01");
			...
			beast = function ( _action, _nearTile = null )
			{
				...
				local distanceToNextSettlement = _action.getDistanceToSettlements(tile);
				local party = _action.getFaction().spawnEntity(tile, "WԄքe", false, this.Const.World.Spawn.Serpents, this.Math.rand(80, 120) * _action.getScaledDifficultyMult() * this.Math.maxf(0.7, this.Math.minf(1.5, distanceToNextSettlement / 14.0)));
				party.getSprite("banner").setBrush("banner_beasts_01");
		...
		if (this.Const.DLC.Unhold)
		{
			beast = function ( _action, _nearTile = null )
			{
				...
				local distanceToNextSettlement = _action.getDistanceToSettlements(tile);
				local party = _action.getFaction().spawnEntity(tile, "Webknechty", false, this.Const.World.Spawn.Spiders, this.Math.rand(80, 120) * _action.getScaledDifficultyMult() * this.Math.maxf(0.7, this.Math.minf(1.5, distanceToNextSettlement / 14.0)));
				party.getSprite("banner").setBrush("banner_beasts_01");
			...
			beast = function ( _action, _nearTile = null )
			{
				...
				local distanceToNextSettlement = _action.getDistanceToSettlements(tile);
				local party = _action.getFaction().spawnEntity(tile, "Alpy", false, this.Const.World.Spawn.Alps, this.Math.rand(80, 120) * _action.getScaledDifficultyMult() * this.Math.maxf(0.7, this.Math.minf(1.5, distanceToNextSettlement / 14.0)));
				party.getSprite("banner").setBrush("banner_beasts_01");
				party.setDescription("Blade i zmizerniałe istoty, skradające się po okolicy.");
			...
			beast = function ( _action, _nearTile = null )
			{
				...
				local distanceToNextSettlement = _action.getDistanceToSettlements(tile);
				local party = _action.getFaction().spawnEntity(tile, "WiedЄmy", false, this.Const.World.Spawn.HexenAndMore, this.Math.rand(80, 120) * _action.getScaledDifficultyMult() * this.Math.maxf(0.7, this.Math.minf(1.5, distanceToNextSettlement / 14.0)));
				party.getSprite("banner").setBrush("banner_beasts_01");
				party.setDescription("Złośliwa stara jędza, która ponoć wabi i porywa małe dzieci, aby robić z nich rosół i mikstury, zawiera podłe pakty z wieśniakami i rzuca klątwy.");
			...
			beast = function ( _action, _nearTile = null )
			{
				...
				local distanceToNextSettlement = _action.getDistanceToSettlements(tile);
				local party = _action.getFaction().spawnEntity(tile, "Schraty", false, this.Const.World.Spawn.Schrats, this.Math.rand(80, 120) * _action.getScaledDifficultyMult() * this.Math.maxf(0.7, this.Math.minf(1.5, distanceToNextSettlement / 14.0)));
				party.getSprite("banner").setBrush("banner_beasts_01");
				party.setDescription("Stwór z kory i drewna, kryjący się za drzewami i włóczący się powoli, z konarami przekopującymi się przez ziemię.");
			...
			beast = function ( _action, _nearTile = null )
			{
				...
				party.getSprite("banner").setBrush("banner_beasts_01");
				party.setDescription("Mackowata potworność z jakiejś innej ery.");
		...
		if (this.Const.DLC.Desert)
		{
			beast = function ( _action, _nearTile = null )
			{
				...
				local distanceToNextSettlement = _action.getDistanceToSettlements(tile);
				local party = _action.getFaction().spawnEntity(tile, "Ifrity", false, this.Const.World.Spawn.SandGolems, this.Math.rand(80, 120) * _action.getScaledDifficultyMult() * this.Math.maxf(0.7, this.Math.minf(1.5, distanceToNextSettlement / 14.0)));
				party.getSprite("banner").setBrush("banner_beasts_01");
