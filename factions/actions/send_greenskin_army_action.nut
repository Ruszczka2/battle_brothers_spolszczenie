this.send_greenskin_army_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		local party = this.World.FactionManager.getFactionOfType(this.Const.FactionType.Orcs).spawnEntity(myTile, "Horda Zielonosk\x0480rych", false, this.Const.World.Spawn.GreenskinHorde, this.Math.rand(80, 120) * this.getScaledDifficultyMult());
