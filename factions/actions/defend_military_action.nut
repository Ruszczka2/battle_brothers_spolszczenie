this.defend_military_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		{
			local party = this.getFaction().spawnEntity(spawnpoints[i], "Kompania " + this.m.Settlement.getName(), true, this.Const.World.Spawn.Noble, this.m.Settlement.getResources());
