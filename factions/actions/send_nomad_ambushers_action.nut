this.send_nomad_ambushers_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		local party = this.getFaction().spawnEntity(settlement.getTile(), "Koczownicy", false, this.Const.World.Spawn.NomadRaiders, this.Math.rand(75, 120) * this.getReputationToDifficultyLightMult());
