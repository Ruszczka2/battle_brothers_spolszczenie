this.send_citystate_army_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		{
			local party = _faction.spawnEntity(spawnpoints[i], "PuՄk z " + _faction.getNameOnly(), true, this.Const.World.Spawn.Southern, this.Math.rand(80, 120) * this.getScaledDifficultyMult());
