this.send_supplies_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		local party = _faction.spawnEntity(this.m.Start.getTile(), "Karawana Zaopatrzeniowa", false, this.Const.World.Spawn.NobleCaravan, r * 100);
		party.getSprite("base").Visible = false;
		party.setMirrored(true);
		party.setDescription("Karawana z uzbrojoną eskortą, przewożąca żywność, zapasy oraz ekwipunek między osadami.");
