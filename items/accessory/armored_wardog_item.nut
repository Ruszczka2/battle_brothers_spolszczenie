this.armored_wardog_item <- this.inherit("scripts/items/accessory/wardog_item", {
	...
	function create()
	{
		...
		this.m.Description = "Silny i wierny pies, wyhodowany na potrzeby wojenne. Można spuścić go ze smyczy w bitwie, aby dokonał zwiadu, wyśledził lub dogonił uciekających wrogów. Ma na sobie skórzany pancerz, chroniący go przed obrażeniami ciętymi.";
