this.iron_will_potion_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Mikstura Żelaznej Woli";
		this.m.Description = "Już sam łyczek łagodzi ból i sprawia, że krew żwawiej płynie. Spodziewaj się wyraźnego palenia w gardle i zgagi. Pij rozważnie. Działa na czas kolejnej bitwy.";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Rany nie mają wpływu na postać, ani nowe, ani stare"
		});
		result.push({
			id = 65,
			type = "text",
