this.heavily_armored_warhound_item <- this.inherit("scripts/items/accessory/warhound_item", {
	...
	function create()
	{
		...
		this.m.Description = "Silny i wierny północny ogar, wyhodowany na potrzeby wojenne. Można spuścić go ze smyczy w bitwie, aby dokonał zwiadu, wyśledził lub dogonił uciekających wrogów. Ma na sobie gruby skórzany pancerz dla lepszej ochrony";
