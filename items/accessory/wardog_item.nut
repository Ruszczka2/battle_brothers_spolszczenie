this.wardog_item <- this.inherit("scripts/items/accessory/accessory", {
	...
	function getDescription()
	{
		...
		{
			return "Obroża psa wojennego, który został spuszczony ze smyczy.";
		}
	}
	...
	function create()
	{
		...
		this.m.Name = this.Const.Strings.WardogNames[this.Math.rand(0, this.Const.Strings.WardogNames.len() - 1)] + ", Pies Wojenny";
		this.m.Description = "Silny i wierny pies, wyhodowany na potrzeby wojenne. Można spuścić go ze smyczy w bitwie, aby dokonał zwiadu, wyśledził lub dogonił uciekających wrogów.";
