this.warhound_item <- this.inherit("scripts/items/accessory/accessory", {
	...
	function getDescription()
	{
		...
		{
			return "Obroża ogara wojennego, który został spuszczony ze smyczy.";
		}
	}
	...
	function create()
	{
		...
		this.m.Name = this.Const.Strings.WardogNames[this.Math.rand(0, this.Const.Strings.WardogNames.len() - 1)] + ", Ogar Wojenny";
		this.m.Description = "Silny i wierny północny ogar, wyhodowany na potrzeby wojenne. Można spuścić go ze smyczy w bitwie, aby dokonał zwiadu, wyśledził lub dogonił uciekających wrogów.";
	...
	function onEquip()
	{
		...
		unleash.m.Name = "Spuść Ogara Wojennego";
		unleash.m.Description = "Spuść ze smyczy ogara wojennego i wyślij go na wroga. Wymaga wolnego przyległego pola.";
