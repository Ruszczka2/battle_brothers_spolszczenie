this.wolf_item <- this.inherit("scripts/items/accessory/accessory", {
	...
	function getDescription()
	{
		...
		{
			return "Obroża wilka, który został spuszczony ze smyczy.";
		}
	}
	...
	function create()
	{
		...
		this.m.Name = this.Const.Strings.WardogNames[this.Math.rand(0, this.Const.Strings.WardogNames.len() - 1)] + ", Wilk";
		this.m.Description = "Silny i dziki wilk, oswojony, aby być wiernym kompanem w bitwie. Można spuścić go ze smyczy w bitwie, aby dokonał zwiadu, wyśledził lub dogonił uciekających wrogów.";
