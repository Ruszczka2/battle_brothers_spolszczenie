this.lionheart_potion_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Mikstura Lwiego Serca";
		this.m.Description = "Bądź odważny niczym lew! Ta mikstura łagodzi strach i wyzwala odwagę, a nawet powoduje lekkie przecenianie swoich umiejętności. Pij rozważnie. Działa na czas kolejnej bitwy.";
