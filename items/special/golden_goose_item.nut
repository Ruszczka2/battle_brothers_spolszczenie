this.golden_goose_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Złota Gęś";
		this.m.Description = "Niewielka statuetka gęsi wykonana z litego złota. Każdego dnia w tajemniczy sposób ze statuetki wyłania się maleńkie złote jajeczko.";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Generuje [color=" + this.Const.UI.Color.PositiveValue + "]15[/color] koron dziennie."
		});
		return result;
	}
