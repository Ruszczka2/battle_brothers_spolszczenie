this.bodily_reward_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Zielona Fiolka";
		this.m.Description = "Wytargowana od złowrogiej wiedźmy kosztem życia innego człowieka, ta tajemnicza mikstura jest rzekomo magicznym napojem dla ciała, który wyleczy wszystkie rany, które same z siebie też by się zagoiły.";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Natychmiastowo leczy wszystkie tymczasowe rany i kontuzje, a także stany \'Wyczerpany\' oraz \'Kac\'"
		});
		result.push({
			id = 65,
			type = "text",
