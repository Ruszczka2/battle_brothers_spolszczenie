this.fountain_of_youth_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Bukłak";
		this.m.Description = "Skórzany bukłak wypełniony płynem spod dziwacznego drzewa o ludzkim kształcie. Coś ci szepta w głowie, że wypicie zawartości uleczy każde rany.";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Usunie wszystkie tymczasowe i trwałe rany oraz kontuzje, a także efekty i cechy \'Stary\', \'Uzależniony\', \'Wyczerpany\' oraz \'Kac\'."
		});
		result.push({
			id = 65,
			type = "text",
