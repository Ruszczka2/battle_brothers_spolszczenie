this.kettle_hat_with_closed_mail <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Kapalin z Pełnym Kapturem Kolczym";
		this.m.Description = "Całkowicie metalowy hełm z szerokim rondem i kapturem kolczym chroniącym kark oraz twarz.";
