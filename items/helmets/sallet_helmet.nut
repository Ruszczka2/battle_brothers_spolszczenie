this.sallet_helmet <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Salada";
		this.m.Description = "Metalowa salada z wydłużoną ochroną karku, dość nietypowy hełm w tych stronach. Został umiejętnie wykonany i zapewnia maksymalną ochronę przy minimalnej wadze. Nie ogranicza też pola widzenia.";
