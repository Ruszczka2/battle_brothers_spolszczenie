this.closed_flat_top_with_mail <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Zamknięty Płaski Hełm Kolczy";
		this.m.Description = "Zamknięty hełm z kompletną zasłoną na twarz i kapturem kolczym osłaniającym kark. Doskonały jeśli idzie o ochronę, ale ciężko się w nim oddycha i pole widzenia jest ograniczone.";
