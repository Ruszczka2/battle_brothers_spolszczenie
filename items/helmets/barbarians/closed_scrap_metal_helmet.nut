this.closed_scrap_metal_helmet <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Zamknięty Hełm ze Złomu";
		this.m.Description = "Ten ciężki metalowy hełm chroni także twarz osoby go noszącej, jednak kosztem ograniczonej widoczności.";
