this.closed_flat_top_helmet <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Zamknięty Płaski Hełm";
		this.m.Description = "Zamknięty hełm z kompletną zasłoną na twarz. Ciężko się w nim oddycha i pole widzenia jest ograniczone.";
