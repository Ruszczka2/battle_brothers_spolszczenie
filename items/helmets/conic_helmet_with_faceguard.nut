this.conic_helmet_with_faceguard <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Stożkowaty Hełm z Zasłoną";
		this.m.Description = "Ten stożkowaty hełm z osłoną kolczą ma podczepioną zasłonę na twarz. Jest ciężki i trudno się przez niego patrzy, ale zapewnia doskonałą ochronę.";
