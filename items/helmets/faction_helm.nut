this.faction_helm <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Dekorowany Hełm Garnczkowy";
		this.m.Description = "Zamknięty metalowy hełm z otworami wentylacyjnymi i wymyślną dekoracją na szczycie. Doskonały jeśli idzie o ochronę, ale ciężko się w nim oddycha i pole widzenia jest ograniczone.";
