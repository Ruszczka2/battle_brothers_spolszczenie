this.closed_flat_top_with_neckguard <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Zamknięty Pikowany Płaski Hełm";
		this.m.Description = "Zamknięty hełm z kompletną zasłoną na twarz i pikowanym czepcem. Ciężko się w nim oddycha i pole widzenia jest ograniczone.";
