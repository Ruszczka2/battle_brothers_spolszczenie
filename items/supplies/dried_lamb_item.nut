this.dried_lamb_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Suszona Jagnięcina";
		this.m.Description = "Prowiant. Suszona jagnięcina jest specjałem i wielce pożądaną przekąską na południu. Prawdziwy smakołyk dla każdego zgłodniałego najemnika.";
