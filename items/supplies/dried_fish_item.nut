this.dried_fish_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Suszona Ryba";
		this.m.Description = "Prowiant. Ryby są pospolitym i sycącym pożywieniem w regionach nabrzeżnych. Suszy się je, by zachować je na dłużej.";
