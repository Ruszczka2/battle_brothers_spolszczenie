	...
	function getTooltip()
	{
		local result = [
			...
			},
			{
				id = 2,
				type = "description",
				text = "Liczba [color=" + this.Const.UI.Color.PositiveValue + "]" + this.m.Amount + "[/color] koron, waluty tych ziem. Zostaną dodane do twego globalnego zapasu monet, gdy wrócisz na mapę świata."
			}
		];
