this.black_marsh_stew_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Potrawka z Czarnych Moczarów";
		this.m.Description = "Prowiant. Czarna niczym moczary, z których się wywodzi, ta okropna potrawka obok smacznych posiłków nawet nie stała, ale wieki miną, zanim się zepsuje. Prawdopodobnie dlatego, że już sama w sobie jest zepsuta.";
