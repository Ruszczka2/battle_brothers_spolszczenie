this.goat_cheese_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Kozi Ser";
		this.m.Description = "Prowiant. Kozi ser jest smacznym i bogatym pożywieniem, powszechnym i popularnym zwłaszcza w zimniejszych regionach północy.";
