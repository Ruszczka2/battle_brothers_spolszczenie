	...
	function getTooltip()
	{
		local result = [
			...
			},
			{
				id = 2,
				type = "description",
				text = "Dobre [color=" + this.Const.UI.Color.PositiveValue + "]" + this.m.Amount + "[/color] jednostek ziół, maści, naparów, bandaży i tym podobnych, aby wspomóc twych najemników w powrocie do zdrowia i uleczeniu ran odniesionych w bitwie. Zostaną dodane do twego globalnego zapasu medykamentów, gdy wrócisz na mapę świata."
			}
		];
