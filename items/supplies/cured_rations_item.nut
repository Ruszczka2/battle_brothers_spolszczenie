this.cured_rations_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Mistrzowsko Zakonserwowane Racje";
		this.m.Description = "Prowiant. Te racje żywnościowe składają się z różnorakich i dobrze zaprawionych mięs ora warzyw, zamkniętych w małych pudełkach. Idealny prowiant na długie wyprawy i ekspedycje w nieznane.";
