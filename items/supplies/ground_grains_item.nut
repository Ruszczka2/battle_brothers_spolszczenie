this.ground_grains_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Ziarno";
		this.m.Description = "Prowiant. Różne rodzaje ziaren zbożowych, które gotuje się z wodą lub mlekiem, by otrzymać typowy dzienny posiłek - sycący, choć pozbawiony smaku.";
