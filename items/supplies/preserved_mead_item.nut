this.preserved_mead_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Zakonserwowany Miód Pitny";
		this.m.Description = "Prowiant. Ten popielaty płyn ma w sobie maleńkie srebrzące się iskierki. Smak ma niezbyt przyjemny, ale rzadko się psuje.";
