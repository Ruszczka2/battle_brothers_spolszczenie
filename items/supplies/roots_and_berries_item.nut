this.roots_and_berries_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Korzenie i Jagody";
		this.m.Description = "Prowiant. Suszone korzenie i jagody nie są najwykwintniejszym jadłem, ale są ogólnodostępne i długo zdatne do spożycia.";
