this.mead_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Miód Pitny";
		this.m.Description = "Prowiant. Napój alkoholowy wykonany z miodu. Wytrzymały i smaczny, a także bezpieczniejszy do picia, niż nieoczyszczona woda.";
