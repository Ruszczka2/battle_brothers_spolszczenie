this.fermented_unhold_heart_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Sfermentowane Serce Unholda";
		this.m.Description = "Prowiant. Niegdyś był to delikates dla barbarzyńskich królów północy, którzy chcieli podnieść swoją jurność, choć przyznać trzeba, że sfermentowane serce Unholda w istocie smakuje nad wyraz paskudnie.";
