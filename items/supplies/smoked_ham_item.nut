this.smoked_ham_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Wędzona Szynka";
		this.m.Description = "Prowiant. Jest wiele sposobów na konserwację żywności. Ten kawałek szynki spędził odpowiednią ilość czasu w wędzarni.";
