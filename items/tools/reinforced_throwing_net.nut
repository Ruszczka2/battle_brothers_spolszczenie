this.reinforced_throwing_net <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Wzmocniona Sieć";
		this.m.Description = "Sieć używana do rzucania na cel, by ograniczyć jego zdolności ruchowe i skuteczność obrony. Wzmocniona pajęczyną webknechtów, by jeszcze ciężej było się z niej oswobodzić.";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			type = "text",
			icon = "ui/icons/special.png",
			text = "Szansa na uwolnienie się jest niższa o [color=" + this.Const.UI.Color.NegativeValue + "]-15[/color]"
		});
		return result;
	}
