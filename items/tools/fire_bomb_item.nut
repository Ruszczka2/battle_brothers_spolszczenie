this.fire_bomb_item <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Ognisty Garnuszek";
		this.m.Description = "Gliniany garnek wypełniony łatwopalnym płynem, który po rzucie spowije obszar w ogniu.";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Podpali [color=" + this.Const.UI.Color.DamageValue + "]7[/color] pól na czas 2 rund"
		});
		result.push({
			id = 6,
			type = "text",
