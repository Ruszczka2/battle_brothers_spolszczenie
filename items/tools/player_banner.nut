this.player_banner <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Chorągiew Bitewna";
		this.m.Description = "Sztandar kompanii niesiony do bitwy. Trzymany wysoko podbudowuje na duchu sojuszników, a wrogom oznajmia kto zaraz ich zmiażdży.";
		this.m.Categories = "Broń drzewcowa, dwuręczna";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Sojusznicy w zasięgu 4 pól otrzymują dodatkowo [color=" + this.Const.UI.Color.PositiveValue + "]10%[/color] Stanowczości postaci, która dzierży chorągiew (maksymalnie do poziomu Stanowczości chorążego)."
		});
		return result;
	}
