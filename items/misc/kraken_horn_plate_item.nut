this.kraken_horn_plate_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Description = "Pozyskana z głowy legendarnego krakena, ta wielka i twarda rogowa płyta stanowi trofeum, jakim niewielu na świecie może się pochwalić.";
