this.paint_white_green_yellow_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Biała, Zielona i Żółta Farba";
		this.m.Description = "Kubełki białej, zielonej i żółtej farby. Można ich użyć, aby pomalować większość hełmów.";
	...
	function getTooltip()
	{
		...
		result.push({
			id = 65,
			type = "text",
			text = "Kliknij prawym przyciskiem myszy lub przeciągnij na hełm obecnie wybranej postaci, aby pomalować. Przedmiot zostanie zużyty po wykorzystaniu."
		});
		return result;
	}
