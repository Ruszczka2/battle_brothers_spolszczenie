this.potion_of_oblivion_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Mikstura Otchłani";
		this.m.Description = "Lepiej nie pytać jak smakuje ta mieszanka najrzadszych i najdziwaczniejszych składników! Ktokolwiek ją wypije, ponoć będzie mógł przeżyć swe życie na nowo, zmieniając decyzje podjęte gdzieś po drodze.";
