this.paint_set_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Zestaw Farb";
		this.m.Description = "Paleta kilku intensywnych kolorów oraz zestaw pędzli. Można ich użyć, aby pomalować pospolite tarcze w barwy twojej kompanii.";
	...
	function getTooltip()
	{
		...
		result.push({
			id = 65,
			type = "text",
			text = "Kliknij prawym przyciskiem myszy lub przeciągnij na niesioną tarczę obecnie wybranej postaci, aby pomalować. Przedmiot zostanie zużyty po wykorzystaniu."
		});
		return result;
	}
