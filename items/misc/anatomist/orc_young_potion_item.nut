this.orc_young_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Syrop Kinetyka";
		this.m.Description = "Poczuj, jak w twoich żyłach płynie siła orka! Wypicie tego eliksiru nasyci ciosy nawet najłagodniejszego z mężczyzn intensywną, niszczycielską mocą zielonoskórego olbrzyma, masz to jak w banku!";
		this.m.IconLarge = "";
