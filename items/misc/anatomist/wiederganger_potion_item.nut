this.wiederganger_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Mikstura Skórzanej Skóry";
		this.m.Description = "Po wypiciu, ten potężny napar modyfikuje skórę, aby reagowała błyskawicznie na nagłe uderzenia, chroniąc ciało przed poważnymi ranami! Nie przejmuj się zapachem, świadczy on tylko o sile mikstury.";
		this.m.IconLarge = "";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Granica otrzymania ran i kontuzji po otrzymaniu obrażeń zostaje podwyższona o [color=" + this.Const.UI.Color.PositiveValue + "]33%[/color]"
		});
		result.push({
			id = 65,
			type = "text",
