this.kraken_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Napar Króla Bagien";
		this.m.Description = "Wciel się w postać bestii nad bestiami! Dzięki temu cudownemu eliksirowi kaleka stanie się mocarzem, a mocarz - bogiem! Znane skutki uboczne obejmują zwiększony apetyt oraz drobne halucynacje.";
		this.m.IconLarge = "";
