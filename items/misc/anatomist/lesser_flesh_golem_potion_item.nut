this.lesser_flesh_golem_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Mikstura Zmiany";
		this.m.Description = "Ten obrzydliwie smakujący napój, destylowany z resztek cielesnego golema, wyleczy ból stawów, zwiększy masę mięśniową, a nawet wyostrzy wzrok! Wyniki nie są gwarantowane.";
		this.m.IconLarge = "";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Postać zyska losową pozytywną cechę"
		});
		result.push({
			id = 65,
			type = "text",
