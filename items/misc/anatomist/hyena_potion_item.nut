this.hyena_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Wywar Krwawych Wrót";
		this.m.Description = "Uwarzony z nieznanego wcześniej gruczołu dzikiej hieny pustynnej, ten krzepki napój zamieni nawet najsłabszego człowieka w symbol wytrzymałości. Nawet najpoważniejsze rany przestaną krwawić i zasklepią się w ułamku sekundy.";
		this.m.IconLarge = "";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Obrażenia od krwawienia są zredukowane o [color=" + this.Const.UI.Color.NegativeValue + "]50%[/color]"
		});
		result.push({
			id = 65,
			type = "text",
