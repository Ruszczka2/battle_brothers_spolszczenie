this.greater_flesh_golem_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Mikstura Postępu";
		this.m.Description = "To serum, pozyskiwane ze szpiku kostnego tzw. „większych” golemów, jest w stanie nawet najbardziej schorowanych uczynić okazem zdrowia. Oto przed wami pokrętna wizja Wielkiego Wróżbity, rozwikłana i urzeczywistniona!";
		this.m.IconLarge = "";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Postać zyska dwie losowe pozytywne cechy"
		});
		result.push({
			id = 65,
			type = "text",
