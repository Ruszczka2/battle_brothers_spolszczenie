this.orc_warlord_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Description = "Wielu generałów marzyło o tym, by orków oswoić, wszak można by wtedy pokierować ich brutalną siłą przy pomocy ludzkiej inteligencji, co dało by im władzę nad niepowstrzymaną mocą. Ten napar sprawia, że takie pragnienia są na wyciągnięcie ręki!";
		this.m.IconLarge = "";
