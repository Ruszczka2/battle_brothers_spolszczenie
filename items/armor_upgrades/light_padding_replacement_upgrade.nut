this.light_padding_replacement_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Lekki Zamiennik Wyściółki";
		this.m.Description = "Ta wykonana z egzotycznym materiałów wyściółka zapewnia taką samą ochronę jak zwykła wyściółka, lecz jest wyraźnie lżejsza.";
		this.m.ArmorDescription = "Ta zbroja ma wymienioną wyściółkę na lżejszą, lecz wcale nie mniej wytrzymałą.";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Zmniejsza karę zbroi do maksymalnego zmęczenia o [color=" + this.Const.UI.Color.NegativeValue + "]20%[/color]"
		});
		return result;
	}
