this.metal_plating_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Metalowe Płytki i Nity";
		this.m.Description = "Grube metalowe płytki, które można przynitować do zbroi. Bardzo prymitywny, ale skuteczny sposób na szybkie zwiększenie ochrony.";
		this.m.ArmorDescription = "Ta zbroja ma warstwę prymitywnie przynitowanych metalowych płytek dla zapewnienia dodatkowej ochrony.";
