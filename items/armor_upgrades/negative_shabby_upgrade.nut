this.negative_shabby_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Sfatygowana";
		this.m.Description = "";
		this.m.ArmorDescription = "Wygląda na to, że poprzedni właściciel zupełnie o zbroję nie dbał; brakuje elementów, lub zastąpiono je improwizowanymi łatkami.";
		this.m.Icon = null;
