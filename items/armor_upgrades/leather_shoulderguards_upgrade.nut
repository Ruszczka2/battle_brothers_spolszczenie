this.leather_shoulderguards_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Skórzane Naramienniki";
		this.m.Description = "Ćwiekowane naramienniki mogą pomóc nawet lekkim pancerzom stać się nieco bardziej wytrzymałymi.";
		this.m.ArmorDescription = "Naramienniki z ćwiekowanej skóry zostały przyczepione do tej zbroi w celu dodatkowej ochrony.";
