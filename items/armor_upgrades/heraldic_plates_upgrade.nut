this.heraldic_plates_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Heraldyczne Naramienniki";
		this.m.Description = "Wielkie ochronne płyty, które można przymocować na ramionach zbroi.";
		this.m.ArmorDescription = "Wielkie ochronne płyty zostały przymocowane na ramionach tej zbroi.";
