this.leather_neckguard_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Skórzany Obojczyk";
		this.m.Description = "Ten obojczyk z garbowanej skóry może zostać przyczepiony do dowolnej zbroi w celu zwiększenia ochrony.";
		this.m.ArmorDescription = "Obojczyk z garbowanej skóry został przyczepiony do tej zbroi w celu dodatkowej ochrony.";
