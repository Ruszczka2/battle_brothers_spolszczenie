this.mail_patch_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Narzuta Kolcza";
		this.m.Description = "Spory kawałek kolczugi, który można dodać do dowolnej zbroi, aby zwiększyć ochronę narażonych partii ciała.";
		this.m.ArmorDescription = "Spory kawałek kolczugi został dodany do tej zbroi, by zwiększyć ochronę narażonych partii ciała";
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "[color=" + this.Const.UI.Color.PositiveValue + "]+20[/color] wytrzymałości"
		});
		result.push({
			id = 14,
			type = "text",
