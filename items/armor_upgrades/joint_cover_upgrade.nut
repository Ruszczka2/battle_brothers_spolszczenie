this.joint_cover_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Metalowe Osłony Łączeń";
		this.m.Description = "Pokaźne metalowe płytki, które osłaniają wrażliwe łączenia na ramionach.";
		this.m.ArmorDescription = "Pokaźne metalowe płytki zostały dodane do tej zbroi, aby chronić wrażliwe łączenia na ramionach.";
