this.double_mail_upgrade <- this.inherit("scripts/items/armor_upgrades/armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Podwójny Ochraniacz Kolczy";
		this.m.Description = "Gruby, podwójny kolczy ochraniacz. Ciężki, ale efektywny w poprawianiu ochrony zbroi.";
		this.m.ArmorDescription = "Gruby, podwójny kolczy ochraniacz został dodany do tej zbroi dla lepszej ochrony.";
