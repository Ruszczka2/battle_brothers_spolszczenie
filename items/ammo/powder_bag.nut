this.powder_bag <- this.inherit("scripts/items/ammo/ammo", {
	...
	function create()
	{
		...
		this.m.Name = "Worek Prochu";
		this.m.Description = "Worek z czarnym prochem, używanym do nabijania egzotycznej broni palnej. Zostaje automatycznie uzupełniony po każdej bitwie, jeżeli masz wystarczającą ilość amunicji.";
