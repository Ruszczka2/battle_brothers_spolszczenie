this.quiver_of_bolts <- this.inherit("scripts/items/ammo/ammo", {
	...
	function create()
	{
		...
		this.m.Name = "Kołczan Bełtów";
		this.m.Description = "Kołczan pełen bełtów, wymaganych, aby móc używać kusz. Zostaje automatycznie uzupełniony po każdej bitwie, jeżeli masz wystarczającą ilość amunicji.";
