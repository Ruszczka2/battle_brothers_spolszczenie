this.hide_and_bone_armor <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Name = "Zbroja Skórzano-Kościana";
		this.m.Description = "Skóry i kości są powszechnym materiałem w północnych regionach. Ta zbroja zbroja wykorzystuje je oba, zapewniając przyzwoitą ochronę.";
