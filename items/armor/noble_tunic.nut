this.noble_tunic <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Name = "Szlachecka Tunika";
		this.m.Description = "Piękna lniana tunika ze wspaniałego materiału, ozdobiona cieszącymi oko haftami. Modna, choć zapewniająca niewielką ochronę.";
