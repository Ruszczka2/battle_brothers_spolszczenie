this.heraldic_armor <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Name = "Heraldyczna Hauberka";
		this.m.Description = "Hauberka kolcza wzmocniona naramiennikami, dodatkowymi płytami metalu i ćwiekowaną zbroją skórzaną, pokrytą tabardem w kolorach szlacheckiego rodu.";
