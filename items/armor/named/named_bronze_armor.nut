this.named_bronze_armor <- this.inherit("scripts/items/armor/named/named_armor", {
	...
	function create()
	{
		...
		this.m.Description = "Ta zbroja zrobiona jest z dziwnego stopu i jest dość dobrze wykonana, jak na barbarzyńskie standardy. Prawdziwie rzadki i niezwykły okaz.";
		this.m.NameList = [
			"Zmatowiała Kamizelka",
			"Zbroja Płytowa ze Stopu",
			"Splamiona Ostoja",
			"Plemienna Płytówka"
		];
		this.m.PrefixList = [
