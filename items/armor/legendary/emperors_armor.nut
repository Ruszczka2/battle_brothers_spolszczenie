this.emperors_armor <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Name = "Zbroja Cesarza";
		this.m.Description = "Lśniąca zbroja, noszona przez samego cesarza w czasach, które dawno już minęły, nasączona magiczną energią. Światło odbija się z łatwością od wypolerowanego pancerza, zamieniając w ciągu dnia noszącą ją osobę w migoczącą świetlistą postać.";
