this.mail_and_lamellar_plating <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Name = "Kolczuga z Płytową Lamelką";
		this.m.Description = "Lamelkowa koszula zrobiona z nachodzących na siebie metalowych płyt, noszona na koszuli kolczej.";
