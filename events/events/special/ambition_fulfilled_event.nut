this.ambition_fulfilled_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Title = "Wypełniona ambicja";
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				foreach( bro in brothers )
				{
					...
					{
						bro.improveMood(this.Const.MoodChange.AmbitionFulfilled, "Nabrał przekonania co do twego przywództwa");
					}
				}
