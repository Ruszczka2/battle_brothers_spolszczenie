this.defeat_holywar_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Ognie religijnej zawieruchy grożą rozlaniem się po krainie. Niech kompania\nzahartuje się w jej żarze oraz zdobędzie fortunę wygrywając wojnę!";
		this.m.UIText = "Zakończ wojnę północy z południem";
		this.m.TooltipText = "Wybierz albo północne rody szlacheckie, albo południowe państwa-miasta i pracuj dla nich, by wygrali swoją świętą wojnę. Każda zniszczona armia oraz każdy wypełniony kontrakt zbliżają cię do zakończenia wojny.";
